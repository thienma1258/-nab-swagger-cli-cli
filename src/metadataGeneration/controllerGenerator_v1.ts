...
// export class ControllerGeneratorV1 {
...
//   constructor(private readonly node: ts.ClassDeclaration, private readonly current: MetadataSwaggerGeneratorV1) {
...
//   const methods= this.node.members
//       .filter(m => m.kind === ts.SyntaxKind.MethodDeclaration)
//       .map((m: ts.MethodDeclaration) => new MethodGeneratorV1(m, this.current, this.commonResponses, this.path, this.tags, this.security, this.isHidden))
