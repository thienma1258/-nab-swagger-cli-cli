...
export function getHeaderType(typeArgumentNodes: NodeArray<TypeNode> | undefined, index: number, metadataGenerator: MetadataSwaggerGeneratorV1): Tsoa.HeaderType | undefined {
